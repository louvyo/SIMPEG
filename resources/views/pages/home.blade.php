...
<div class="absolute top-0 left-0 m-4 p-2 rounded shadow typewriter">
    <p class="text-lg md:text-xl font-semibold text-white typewriter-text typewriter-delete">Dinas Pekerjaan Umum dan Penataan Ruang</p>
</div>
    <div class="flex flex-col items-center justify-center h-screen">
        ...
        <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4">
            <a href="#" class="btn btn-primary px-4 py-2 rounded-lg bg-blue-500 hover:bg-blue-700 text-white">Masuk</a>
            <a href="#"
