        ...
        <div x-data="{
            ...
            <div class="bg-gradient-to-r from-blue-900 to-blue-700 p-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-3xl font-bold text-white">Tambah Pegawai Baru</h1>
                        <p class="text-blue-200 mt-2">Lengkapi informasi pegawai</p>
                    </div>
                </div>
            </div>

            {{-- Form Section --}}
            <form x-ref="form" action="{{ route('pegawai.store') }}" method="POST" enctype="multipart/form-data"
                class="p-8 space-y-6">
                @csrf
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip" value="{{ old('nip') }}"
                            class="w-full bg-gray-700 text-white rounded-lg px-4 py-2" placeholder="Masukkan NIP">
                    </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telepon" value="{{ old('no_telepon') }}"
                            class="w-full bg-gray-700 text-white rounded-lg px-4 py-2" placeholder="Nomor telepon">
                    </div>
                </div>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="status" class="w-full bg-gray-700 text-white rounded-lg px-4 py-2" required>
                            ...
                            <option value="Cuti" {{ old('status') == 'Cuti' ? 'selected' : '' }}>
                                Cuti
                            </option>
                ...
                <div>
                    ...
                    <input type="file" name="avatar" class="w-full bg-gray-700 text-white rounded-lg px-4 py-2"
                        accept="image/*">
                </div>
