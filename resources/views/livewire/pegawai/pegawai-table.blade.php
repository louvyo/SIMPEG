<div>
    ...
    <div class="bg-gray-800 rounded-lg overflow-hidden">
        <div wire:loading class="absolute inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div class="flex items-center space-x-2 text-white">
                <svg class="animate-spin h-5 w-5" 
                    ...
                    <path class="opacity-75" 
                          fill="currentColor" 
                          d="M4 12a8 8 0 0 0 8-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 0 0 4 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">
                    </path>
                </svg>
                <span>Memproses...</span>
            </div>
